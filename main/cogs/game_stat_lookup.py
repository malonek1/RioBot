...
NL = "\n"
stat_help_string = (
    "This command lists out stat commands you can use and their functions."
    + NL
    + "Note that `<character>` can also be replaced by the following in some cases: `<best>` `<worst>` `<avg>`"
    + NL
    + NL
    + "**BATTING STATS**:"
    + NL
    + "`!stat <character> charge` ------- Returns the numeric charge hit power for that character"
    + NL
    + "`!stat <character> contact` ------ Returns the numeric slap hit power for that character"
    + NL
    + "`!stat <character> nice` --------- Returns the numeric nice contact zone for that character"
    + NL
    + "`!stat <character> perfect` ------ Returns the numeric perfect contact zone for that character"
    + NL
    + "`!stat <character> bunt` --------- Returns the numeric bunt stat for that character"
    + NL
    + "`!stat <character> traj` --------- Returns the type of trajectory for that character"
    + NL
    + "`!stat <character> starswing` ---- Returns the type of star swing that character has"
    + NL
    + "`!stat <character> cssbat` ------- Returns the numeric batting stat for that character as shown in game (1 to 10)"
    + NL
    + NL
    + "**PITCHING STATS**:"
    + NL
    + "`!stat <character> curvespeed` --- Returns the numeric curve pitch speed for that character"
    + NL
    + "`!stat <character> fastball` ----- Returns the numeric fastball pitch speed for that character"
    + NL
    + "`!stat <character> curve` -------- Returns the numeric curveball curve distance for that character"
    + NL
    + "`!stat <character> 0x2` ---------- Returns the numeric 'cursed ball' stat for that character"
    + NL
    + "`!stat <character> 0x4` ---------- Returns the numeric 0x4 stat for that character"
    + NL
    + "`!stat <character> starpitch` ---- Returns the type of star pitch that character has"
    + NL
    + "`!stat <character> csspitch` ----- Returns the numeric pitching stat for that character as shown in game (1 to 10)"
    + NL
    + NL
    + "**FIELDING STATS**:"
    + NL
    + "`!stat <character> arm` ---------- Returns the numeric arm strength for that character"
    + NL
    + "`!stat <character> dive` --------- Returns the numeric dive range for that character"
    + NL
    + "`!stat <character> radiusair` ---- Returns the numeric hitbox radius that character has when catching a fly ball"
    + NL
    + "`!stat <character> radiusground` - Returns the numeric hitbox radius that character has when catching a ground ball"
    + NL
    + "`!stat <character> height` ------- Returns the numeric height of that character"
    + NL
    + "`!stat <character> cssfield` ----- Returns the numeric fielding stat for that character as shown in game (1 to 10)"
    + NL
    + NL
    + "**BASERUNNING STATS**:"
    + NL
    + "`!stat <character> speed` -------- Returns the numeric running speed for that character"
    + NL
    + "`!stat <character> weight` ------- Returns the numeric weight of that character (0 to 4)"
    + NL
    + "`!stat <character> cssrun` ------- Returns the numeric fielding stat for that character as shown in game (1 to 10)"
    + NL
    + NL
    + "**OTHER STATS**:"
    + NL
    + "`!stat <character> class` -------- Returns the characters class as shown in game"
    + NL
)
...
class GameStatLookup(commands.Cog):
    ...
    async def chemistry(self, ctx):
        embed = discord.Embed()
        embed.add_field(
            name="CHARACTER CHEMISTRY CHART",
