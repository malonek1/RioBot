...
/usr/local/bin/pip3.9 install -U discord.py==2.4.0 glicko2==2.0.0 gspread==5.7.1 oauth2client==4.1.3 Pillow==9.4.0 python-dotenv==0.21.0 pytz==2022.7 requests==2.28.1
